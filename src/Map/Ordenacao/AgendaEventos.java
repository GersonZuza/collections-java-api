...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.MAY, 23), "Evento 5", "Atração 5");
        agendaEventos.adicionarEvento(LocalDate.of(2025, Month.OCTOBER, 20), "Evento 6", "Atração 6");
